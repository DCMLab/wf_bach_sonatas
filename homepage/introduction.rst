...
.. code:: bash
   ...
   git clone https://github.com/DCMLab/wf_bach_sonatas.git
...
* `Wilhelm Friedemann Bach – Piano Sonatas <https://github.com/DCMLab/wf_bach_sonatas/archive/refs/heads/main.zip>`__


Data Formats
============

Each piece in this corpus is represented by five files with identical names, each in its own folder. For example, the first movement of the C-major sonata F. 1 has the following files:
...
.. code:: python
   ...
   labels = ms3.load_tsv('harmonies/F001_n08a.tsv')
   notes = ms3.load_tsv('notes/F001_n08a.tsv')
...
For questions, remarks etc., please `create an issue <https://github.com/DCMLab/wf_bach_sonatas/issues>`__ and feel free to fork and submit pull requests.
